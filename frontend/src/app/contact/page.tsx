    ...
    <div className="mt-10 text-center">
      ...
      <div>
        {contacts.map((contact, index) => (
          <div
            key={index}
            className="bg-[var(--color-neutral-bg)] flex flex-col items-center text-center p-5 mb-5"
          >
...
function AboutUsCard() {
  return (
    <div className="bg-[var(--color-neutral-bg)]">
      <div>
        <Image
      ...
      <div className="mt-10 p-5">
        <p className={`${poppins.className} mb-5 font-medium text-lg mb-3`}>
          About Us
        </p>
      ...
      <div>
        ...
        <div className="flex flex-col mb-8">
          ...
          <input
            ...
            className="text-md border py-2 px-4 pb-35 rounded-md border-[#CBCBCB]"
          />
        </div>
      </div>
      <div>
        <button className={`${poppins.className} bg-black text-white w-full py-2 rounded-md font-semibold`}>Send Message</button>
      </div>
    </div>
  );
}
