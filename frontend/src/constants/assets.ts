...
export const ARTICLE_DEFAULT_IMAGE = '/images/blog/article-placeholder.jpg';
export const SHOP_PAGE_IMAGE = '/images/shop/shopPage.png';
export const NEWSLETTER_BACKGROUND_IMAGE = '/images/home/newsLetterBack.png';
export const MAP_LOCATION_IMAGE = '/images/contact/map.png';