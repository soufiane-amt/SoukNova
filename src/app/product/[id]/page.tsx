...
const popIn = {
  ...
  visible: {
    ...
    transition: {
      duration: 0.5,
      type: "spring", // Use a spring transition for a bouncy effect
      damping: 15,
      stiffness: 120,
    },
  },
...
const fadeAndSlide = {
  ...
  visible: {
    opacity: 1,
    x: 0, // Animates to its final position (0px horizontal offset)
    transition: {
      duration: 0.5,
      ease: 'easeOut',
    },
...
const Traversal = ({ category, productName }: TraversalProps) => {
  return (
    <div className="flex min-h-5 items-center gap-4 font-inter text-sm font-medium text-[#605F5F] max-sm:text-xs py-4">
      ...
      <div className="flex items-center gap-1 truncate font-inter text-sm font-medium text-black">
        <div>
          <a
            className="flex items-center gap-1"
            href={`/shop?category=${category}`}
...
const ProductImage: React.FC<ProductImageProps> = ({ image, isNew }) => {
  return (
    <div className="relative  bg-[#f4f4f4] h-[649px] flex items-center justify-center">
      <Image
        src={image}
        alt={`${image}`}
        width={500}
...
const Product: React.FC<ProductProps> = ({ productData }) => {
  ...
  return (
    productData && (
      <div>
        <Traversal category={categoryValue} productName={productData.title} />
        <div className="lg:flex w-full">
          ...
          <div className="lg:w-[508px] ">
            ...
            <div className="w-full mt-5 border-b border-gray-300 pb-5">
              <motion.button
            ...
            <div className="flex items-center gap-[58px] my-15">
